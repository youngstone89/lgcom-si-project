...
# Added os.path.dirname to the intial version because of settings folder to branch settings.py depending on server env.
...
SECRET_KEY = '+-l9#eyh5zj#h_iqvw(2(dmhwdor0m=u*tqfo1lyh@3km(my(*'
